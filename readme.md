...
- Graphics for forms/items/pets are NO LONGER being added to the Git repository.  If you would like to download all the images for the game, you may download this file:  https://mega.nz/#!bhpRjCbL!sAsVACGE8N7ikO1kUu8BKVZJG-JbNnUb14yWZ_vbmpo (last updated January 7, 2015).  Move the contents of this .7z file to the appropriate folders to see them on your local machine.  Some small key UI elements such as icons will continue to be added to the git repository.