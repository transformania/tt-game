...
namespace TT.Domain.Legacy.Procedures.JokeShop
{
    public static class NovelPrankProcedures
    {
        ...
        public static string TakeIdentity(Player player, Random rand = null)
        {
            ...
            var possibleFirstNames = new string[]{ $"{player.GetFullName()}'s", $"{player.FirstName}'s", $"{(player.Gender == PvPStatics.GenderMale ? "Master" : "Mistress")} {player.LastName}'s", $"Psychopath {player.LastName}'s", "Thief's", "A", "Some", "Just A", "Another", "Yet Aother", "Rejected", "Second Hand", "Second Rate", "Enchanted", "Worthless", "Expensive", "Clean", "Dirty", "Discarded", "Prized", "New", "Old", "Broken", "Boring", "Plain", "Bright", "Dull", "Cherished", "Bespoke", "Mass-Produced", "Downtrodden", "Unloved", "Beloved", "Wanted", "Desirable", "Just Another", "Nobody's", "Somebody's", "Homeless", "Cute", "Pretty", "Ugly", "Tiny", "Huge", "Drab", "Filthy", "Coveted", "Cheap", "Trashy", "Useless", "Silly", "Pathetic", "Ordinary", "Proud", "Demanding", "Ultimate", "Inevitable", "Predestined", "Inescapable", "Devoted", "Loyal", "Obedient", "Lifeless", "Cold", "Hot", "Emotionless", "Regal", "Forever", "Disposable", "Public", "Disowned" };
