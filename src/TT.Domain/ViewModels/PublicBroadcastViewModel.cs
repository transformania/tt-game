...
namespace TT.Domain.ViewModels
{
    ...
    public class PlayerNameViewModel
    {
        ...
        [StringLength(30, MinimumLength = 2, ErrorMessage = "The first name must be between 2 and 12 letters long.")]
        ...
        [StringLength(30, MinimumLength = 2, ErrorMessage = "The last name must be between 2 and 12 letters long.")]
