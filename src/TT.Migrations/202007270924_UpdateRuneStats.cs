...
namespace TT.Migrations
{
    ...
    public class UpdateRuneStats : ForwardOnlyMigration
    {
        public override void Up()
        {
            ...
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Minor Rune of Striking', Discipline = '0', Perception = '0', Charisma = '15', Fortitude = '5', Agility = '0', Allure = '-6', Magicka = '0', Succour = '0', Luck = '15' WHERE id = '449'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Standard Rune of Striking', Discipline = '0', Perception = '0', Charisma = '16', Fortitude = '5', Agility = '0', Allure = '-7', Magicka = '0', Succour = '0', Luck = '16' WHERE id = '458'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Great Rune of Striking', Discipline = '0', Perception = '0', Charisma = '18', Fortitude = '6', Agility = '0', Allure = '-7', Magicka = '0', Succour = '0', Luck = '18' WHERE id = '476'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Major Rune of Striking', Discipline = '0', Perception = '0', Charisma = '19', Fortitude = '6', Agility = '0', Allure = '-8', Magicka = '0', Succour = '0', Luck = '19' WHERE id = '467'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Superior Rune of Striking', Discipline = '0', Perception = '0', Charisma = '21', Fortitude = '7', Agility = '0', Allure = '-8', Magicka = '0', Succour = '0', Luck = '21' WHERE id = '507'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Supreme Rune of Striking', Discipline = '0', Perception = '0', Charisma = '22', Fortitude = '7', Agility = '0', Allure = '-9', Magicka = '0', Succour = '0', Luck = '22' WHERE id = '485'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Legendary Rune of Striking', Discipline = '0', Perception = '0', Charisma = '24', Fortitude = '8', Agility = '0', Allure = '-10', Magicka = '0', Succour = '0', Luck = '24' WHERE id = '494'");
            ...
            // Fox
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Minor Rune of the Fox', Discipline = '-6', Perception = '0', Charisma = '15', Fortitude = '5', Agility = '15', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '525'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Standard Rune of the Fox', Discipline = '-7', Perception = '0', Charisma = '16', Fortitude = '5', Agility = '16', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '526'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Great Rune of the Fox', Discipline = '-7', Perception = '0', Charisma = '18', Fortitude = '6', Agility = '18', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '527'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Major Rune of the Fox', Discipline = '-8', Perception = '0', Charisma = '19', Fortitude = '6', Agility = '19', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '528'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Superior Rune of the Fox', Discipline = '-8', Perception = '0', Charisma = '21', Fortitude = '7', Agility = '21', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '529'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Supreme Rune of the Fox', Discipline = '-9', Perception = '0', Charisma = '22', Fortitude = '7', Agility = '22', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '530'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Legendary Rune of the Fox', Discipline = '-10', Perception = '0', Charisma = '24', Fortitude = '8', Agility = '24', Allure = '0', Magicka = '0', Succour = '0', Luck = '0' WHERE id = '531'");

            // Guardian
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Minor Rune of the Guardian', Discipline = '15', Perception = '0', Charisma = '0', Fortitude = '5', Agility = '0', Allure = '15', Magicka = '0', Succour = '0', Luck = '-6' WHERE id = '532'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Standard Rune of the Guardian', Discipline = '16', Perception = '0', Charisma = '0', Fortitude = '5', Agility = '0', Allure = '16', Magicka = '0', Succour = '0', Luck = '-7' WHERE id = '533'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Great Rune of the Guardian', Discipline = '18', Perception = '0', Charisma = '0', Fortitude = '6', Agility = '0', Allure = '18', Magicka = '0', Succour = '0', Luck = '-7' WHERE id = '534'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Major Rune of the Guardian', Discipline = '19', Perception = '0', Charisma = '0', Fortitude = '6', Agility = '0', Allure = '19', Magicka = '0', Succour = '0', Luck = '-8' WHERE id = '535'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Superior Rune of the Guardian', Discipline = '21', Perception = '0', Charisma = '0', Fortitude = '7', Agility = '0', Allure = '21', Magicka = '0', Succour = '0', Luck = '-8' WHERE id = '536'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Supreme Rune of the Guardian', Discipline = '22', Perception = '0', Charisma = '0', Fortitude = '7', Agility = '0', Allure = '22', Magicka = '0', Succour = '0', Luck = '-9' WHERE id = '537'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Legendary Rune of the Guardian', Discipline = '24', Perception = '0', Charisma = '0', Fortitude = '8', Agility = '0', Allure = '24', Magicka = '0', Succour = '0', Luck = '-10' WHERE id = '538'");

            // Enchantress
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Minor Rune of the Enchantress', Discipline = '0', Perception = '0', Charisma = '-6', Fortitude = '5', Agility = '0', Allure = '0', Magicka = '15', Succour = '0', Luck = '15' WHERE id = '539'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Standard Rune of the Enchantress', Discipline = '0', Perception = '0', Charisma = '-7', Fortitude = '5', Agility = '0', Allure = '0', Magicka = '16', Succour = '0', Luck = '16' WHERE id = '540'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Great Rune of the Enchantress', Discipline = '0', Perception = '0', Charisma = '-7', Fortitude = '6', Agility = '0', Allure = '0', Magicka = '18', Succour = '0', Luck = '18' WHERE id = '541'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Major Rune of The Enchantress', Discipline = '0', Perception = '0', Charisma = '-8', Fortitude = '6', Agility = '0', Allure = '0', Magicka = '19', Succour = '0', Luck = '19' WHERE id = '542'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Superior Rune of the Enchantress', Discipline = '0', Perception = '0', Charisma = '-8', Fortitude = '7', Agility = '0', Allure = '0', Magicka = '21', Succour = '0', Luck = '21' WHERE id = '543'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Supreme Rune of the Enchantress', Discipline = '0', Perception = '0', Charisma = '-9', Fortitude = '7', Agility = '0', Allure = '0', Magicka = '22', Succour = '0', Luck = '22' WHERE id = '544'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Legendary Rune of the Enchantress', Discipline = '0', Perception = '0', Charisma = '-10', Fortitude = '8', Agility = '0', Allure = '0', Magicka = '24', Succour = '0', Luck = '24' WHERE id = '545'");

            // Healer -> Renamed to Acrobat
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Minor Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '5', Agility = '15', Allure = '-6', Magicka = '0', Succour = '0', Luck = '15' WHERE id = '546'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Standard Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '5', Agility = '16', Allure = '-7', Magicka = '0', Succour = '0', Luck = '16' WHERE id = '547'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Great Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '6', Agility = '18', Allure = '-7', Magicka = '0', Succour = '0', Luck = '18' WHERE id = '548'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Major Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '6', Agility = '19', Allure = '-8', Magicka = '0', Succour = '0', Luck = '19' WHERE id = '549'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Superior Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '7', Agility = '21', Allure = '-8', Magicka = '0', Succour = '0', Luck = '21' WHERE id = '550'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Supreme Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '7', Agility = '22', Allure = '-9', Magicka = '0', Succour = '0', Luck = '22' WHERE id = '551'");
            Execute.Sql("Update DbStaticItems SET FriendlyName = 'Legendary Rune of the Acrobat', Discipline = '0', Perception = '0', Charisma = '0', Fortitude = '8', Agility = '24', Allure = '-10', Magicka = '0', Succour = '0', Luck = '24' WHERE id = '552'");
