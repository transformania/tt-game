...
namespace TT.Tests.Players.Queries
{
    ...
    public class CanAttackNpcWithSpellTests : TestBase
    {
        ...
        public void should_return_no_cast_message_for_pet_spell_on_male_rat_thief_boss()
        {
            ...
            Assert.That(DomainRegistry.Repository.FindSingle(cmd),
                Is.EqualTo(
                    "You get the feeling this type of spell won't work against male thief.  Maybe a different one would do..."));
        }
        ...
        public void should_return_emptystring_for_correct_spell_and_form_on_bimbo_mouse()
        {
            var player = new Player
            {
                FormSourceId = BossProcedures_Sisters.NerdSpellFormSourceId
            };
        ...
        public void should_return_message_for_corect_spell_and_incorrect_form_on_bimbo_mouse()
        {
            ...
            Assert.That(DomainRegistry.Repository.FindSingle(cmd),
                Is.EqualTo(
                    "You can't seem to find the right peeved-off mindset to cast this spell against Candice.  Maybe you'd have better luck if you were casting magic against her as a Nerdy Mousegirl..."));
        }
        ...
        public void should_return_message_for_incorrect_spell_and_correct_form_on_bimbo_mouse()
        {
            ...
            Assert.That(DomainRegistry.Repository.FindSingle(cmd),
                Is.EqualTo("This spell won't work against Candice."));
        }
