...
namespace TT.Web.Controllers
{
    ...
    public partial class PvPController : Controller
    {
        ...
        public virtual ActionResult LookAtPlayer(int id)
        {
            ...
            if ((playerLookedAt.Form.MobilityType == PvPStatics.MobilityInanimate || playerLookedAt.Form.MobilityType == PvPStatics.MobilityPet) && !playerLookedAt.Player.InQuest)
            {
