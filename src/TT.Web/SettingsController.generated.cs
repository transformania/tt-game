...
namespace TT.Web.Controllers
{
    ...
    public partial class T4MVC_SettingsController : TT.Web.Controllers.SettingsController
    {
        ...
        [NonAction]
        partial void CreateRPClassifiedAdOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TT.Domain.DTOs.RPClassifiedAds.RPClassifiedAdDetail input);

        [NonAction]
        public override System.Web.Mvc.ActionResult CreateRPClassifiedAd(TT.Domain.DTOs.RPClassifiedAds.RPClassifiedAdDetail input)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CreateRPClassifiedAd);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "input", input);
        ...
        [NonAction]
        partial void UpdateRPClassifiedAdOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, TT.Domain.DTOs.RPClassifiedAds.RPClassifiedAdDetail input);

        [NonAction]
        public override System.Web.Mvc.ActionResult UpdateRPClassifiedAd(TT.Domain.DTOs.RPClassifiedAds.RPClassifiedAdDetail input)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UpdateRPClassifiedAd);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "input", input);
