...
{
    public partial class TransformaniaTimeController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TransformaniaTimeController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TransformaniaTimeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TransformaniaTimeController Actions { get { return MVC.TransformaniaTime; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "transformaniatime";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "transformaniatime";
        [GeneratedCode("T4MVC", "2.0")]
