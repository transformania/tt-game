...
namespace tfgame.ViewModels
{
    public class NewCharacterViewModel
    {
        ...
        [StringLength(30, MinimumLength = 2, ErrorMessage = "Your first name must be between 2 and 30 letters long.")]
        ...
        [StringLength(30, MinimumLength = 2, ErrorMessage = "Your last name must be between 2 and 30 letters long.")]
